...
# Goal: Shadow mapping
#       In this assignment, you will implement the shadow mapping algorithm to render shadows in a scene.
#       Optionally, you will also implement Percentage Closer Filtering (PCF) to improve the quality of the shadows.
...
def render_scene():
    ...
    shaderProgram_scene["view_mat"] = view_mat
    shaderProgram_scene["projection_mat"] = projection_mat

    shaderProgram_scene["light_pos"] = [1, 4, 1]
    ...
    #       In the provided code, this texture has the texture id "depthTex_id" and is bound to texture unit 0.
    #       The texture sampler "depthTex" in the fragment shader is also bound to texture unit 0.
    ...
    shaderProgram_scene["model_mat_obj"] = model_mat_obj
    ...
    shaderProgram_scene["model_mat_obj"] = model_mat_receiver
